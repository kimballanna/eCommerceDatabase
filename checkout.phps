...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Floor Five Checkout - Anna Kimball</title>
					...
					<div class="space">
						<div class="nav">
							<ul>
								...
								<a href="search.php"><img src="img/searchicon.png" class="searchiconcatalog" alt="Search" /></a></li>
							</ul>
						</div>
					</div>
						...
						<div class="customerbilling2">
							<form action="#" id="info2" name="info2" method="post">
								...
								<div id="buttonright">
									...
									<a href="complete.php"><input class="buttoncheckout" type="button" value="Place Order" /></a>
								</div>
								<div>
									<br />
									<br />
