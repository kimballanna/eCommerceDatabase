...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Floor Five Maple Hardwood - Anna Kimball</title>
					...
					<div class ="grid_9">
							...
							<div>
								<div class ="grid_3">
									<?php 
										...
										while($row = mysqli_fetch_array($result)) {
											if ($row['productsid']=="6"){
									?>
												<img id="thumbnailproduct" src="<?php echo $row['productimage'] ?>" alt="Maple Hardwood" />
												<?php
											}
											else {
											}
								...
								<div class ="grid_5">
									<div id="productdescrip">
										...
										?>
										<br /><br />
										<h2>Product rating:</h2> <img src="img/5stars.jpg" class="stars" alt="Rating" /><br /><br /> 
						...
						<div class = "productsspace">
							...
							<div class="productborder">
								...
								<h2>Posted:</h2> Mar 08, 2014<br />
								<h2>Reviewer:</h2> Al Gebra<br />
