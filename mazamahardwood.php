...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Floor Five Mazama Hardwood - Anna Kimball</title>
					...
					<div class ="grid_9">
								...
								<div class ="grid_3">
									<?php 
										...
										while($row = mysqli_fetch_array($result)) {
											if ($row['productsid']=="7"){
									?>
												<img id="thumbnailproduct" src="<?php echo $row['productimage'] ?>" alt="Dante Carpet" />
												<?php
											}
											else {
											}
						...
						<div class = "productsspace">
							...
							<div class="productborder">
								...
								<h2>Rating:</h2> <img src="img/4stars.jpg" class="stars" alt="Rating" /><br />
