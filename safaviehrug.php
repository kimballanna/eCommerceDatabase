...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Floor Five Safavieh Rug - Anna Kimball</title>
								...
								<div class ="grid_3">
									<?php 
										...
										while($row = mysqli_fetch_array($result)) {
											if ($row['productsid']=="2"){
									?>
												<img id="thumbnailproduct" src="<?php echo $row['productimage'] ?>" alt="Safavieh Rug" />
												<?php
											}
											else {
											}
								...
								<div class ="grid_2">
									<?php 
										...
										while($row = mysqli_fetch_array($result)) {
											if ($row['productsid']=="9"){
									?>
												<a href="tauperug.php"><img id="thumbnails10" src="<?php echo $row['productimage'] ?>" alt="Taupe Rug" /></a>
