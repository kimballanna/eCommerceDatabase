...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Floor Five Totoro Mat - Anna Kimball</title>
					...
					<div class ="grid_9">
							...
							<div>
								<div class ="grid_3">
									<?php 
										...
										while($row = mysqli_fetch_array($result)) {
											if ($row['productsid']=="4"){
									?>
												<img id="thumbnailproduct" src="<?php echo $row['productimage'] ?>" alt="Taupe Rug" />
												<?php
											}
											else {
											}
								...
								<div class ="grid_5">
									<div id="productdescrip">
										...
										?>
										<br /><br />
										<h2>Product rating:</h2> <img src="img/4stars.jpg" class="stars" alt="Rating" /><br /><br /> 
						...
						<div class = "productsspace">
							...
							<div class="productborder">
								...
								<h2>Posted:</h2> May, 2013<br />
								<h2>Reviewer:</h2> Anna Mei<br />
								<h2>Rating:</h2> <img src="img/5stars.jpg" class="stars" alt="Rating" /><br />
								<p>I love this product. The material is soft and a great addition to my home.</p>
							</div>
						</div>
					</div>
					<div class="grid_3">
